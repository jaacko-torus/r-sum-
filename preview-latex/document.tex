...
\begin{document}
	...
	\begin{paracol}{2}
		...
		\cvevent{Research Assistant}{\href{https://www.linkedin.com/school/university-of-illinois-urbana-champaign/}{\uline{University of Illinois Urbana--Champaign}}}{December 2023--Present}{Champaign, IL}
		\begin{itemize}
			\item Modernizing atmopsphere simulator
			\item Translating Fortran 90 to Julia
			\item Integrating multiple languages through CMake
			\item Optimizing Julia to be used with the university's cluster
		\end{itemize}

		\divider

		\cvevent{Software Engineer}{\href{https://www.linkedin.com/company/frasca-international-inc-/}{\uline{Frasca International, Inc.}}}{April--December 2022}{Champaign, IL}
		\begin{itemize}
			\item Created aircraft simulators to train pilots, using C++ and C\#
			\item Developed internal tools with WPF and .NET
		\end{itemize}
		...
		\vspace{-0.3cm}
		\begin{justify}
			Language interpreter for ``lox'', a toy-language spec.-ed by \href{https://github.com/munificent}{\uline{Bob Nystrom}} --- a developer of the \href{https://en.wikipedia.org/wiki/Dart_(programming_language)}{\uline{Dart}} language.
		\end{justify}
		\vspace{-0.2cm}
		\smallskip
		\begin{itemize}
