...
export type ContactInfoProps<Category extends ContactInfoCategories> = {
	category: Category,
	data: string,
	href?: string,
	visible: boolean
...
export class ContactInfo<Category extends ContactInfoCategories> {
	...
	constructor(props: ContactInfoParams<Category>) {
		this.props = props
	}
}
...
export class ExperienceInfo {
	...
	constructor(props: ExperienceInfoProps) {
		this.props = {...props}
	}
}

export type SkillInfoCategory =
	"language"
...
export class SkillInfo {
	...
	constructor(props: SkillInfoParams) {
		this.props = props
	}
}
